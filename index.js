...
client.on("message", message => {
 ...
 if (message.content === "&help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『Crawn Gaming』 『اسم البوت』", true)
...
if (message.content === '&support') {
      message.author.send(' |https://discord.gg/5s5msRs| لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === '&invite') {
      message.author.send(' رابط البوت | https://discordapp.com/api/oauth2/authorize?client_id=547488556638142485&permissions=8&scope=bot ').catch(e => console.log(e.stack));
...
const gamestats = [`&help`,`&invite`,`By;!🔱Ꭿ Ꮮ Ꭵ🔱#5566`]
var index = 0
...
const mohamed= member.guild.channels.get("546628027275018241");
if(!mohamed) return;
if(mohamed) {

setTimeout(() => mohamed.send(`**Welcome To Server Crown Gaming**`), 4000)

}

});

const devs = ['536178844588179457' , '' , ''];
